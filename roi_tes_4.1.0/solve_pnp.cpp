...
RM_SolveAngle::RM_SolveAngle(){
    ...
    B_armor3d.push_back(Point3f(-B_half_x, -B_half_y, 0));
    B_armor3d.push_back(Point3f(B_half_x, -B_half_y, 0));
    B_armor3d.push_back(Point3f(B_half_x, B_half_y, 0));
    B_armor3d.push_back(Point3f(-B_half_x, B_half_y, 0));

    L_armor3d.push_back(Point3f(-L_half_x, -L_half_y, 0));
    L_armor3d.push_back(Point3f(L_half_x, -L_half_y, 0));
    L_armor3d.push_back(Point3f(L_half_x, L_half_y, 0));
    L_armor3d.push_back(Point3f(-L_half_x, L_half_y, 0));
...
void RM_SolveAngle::run_SolvePnp(Mat & srcImg, RotatedRect & rect,int armor_size){

    vertex_Sort(rect);

    if(armor_size == big_armor){
        solvePnP(B_armor3d, target2d, cameraMatrix, distCoeffs, rvec, tvec, false, SOLVEPNP_ITERATIVE);
    } else {
        solvePnP(L_armor3d, target2d, cameraMatrix, distCoeffs, rvec, tvec, false, SOLVEPNP_ITERATIVE);
    }
